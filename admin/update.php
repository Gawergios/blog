...
if(isset($id)) {
    ...
    if (isset($_FILES['img'])) {
        ...
        $query = " UPDATE post SET  title='$titlee', artical='$artical' ";
    if ($error == 0) {
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="design/index3.html" class="nav-link">Home</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="design/index3.html" class="brand-link">
                            ...
                            <div class="card-body">
                                <form action="update.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <img src="../img/<?= $data['img']; ?>" width="100px" height="100px">
                                        <div class="form-group">
